        ...
        <form className="max-w-screen-sm purple-100">
          ...
          <fieldset className="mt-7">
            ...
            <input
              ...
              placeholder="급여"
              aria-label="급여"
              className="mt-7 block w-full h-[32px] pl-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-primary focus:border-primary focus:border-2"
            />
            ...
            <div>
              <input
                ...
                id="dateInput"
                aria-label="근무 날짜"
                className="mt-7 block w-full h-[32px] pl-3 pr-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-primary focus:border-primary text-gray-400 focus:border-2"
